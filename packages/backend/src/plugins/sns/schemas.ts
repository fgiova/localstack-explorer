...
export type SubscriptionDetailResponse = Static<typeof SubscriptionDetailResponseSchema>;
...
export const PublishMessageBodySchema = Type.Object({
  ...
  messageAttributes: Type.Optional(Type.Record(Type.String(), MessageAttributeSchema)),
...
export const PublishBatchResponseSchema = Type.Object({
  successful: Type.Array(Type.Object({
    id: Type.String(),
    messageId: Type.String(),
  })),
...
export const FilterPolicyBodySchema = Type.Object({
  filterPolicy: Type.Union([Type.String(), Type.Record(Type.String(), Type.Any())]),
});
