...
export const ReceiveMessagesQuerySchema = Type.Object({
	...
	waitTimeSeconds: Type.Optional(
		Type.Integer({ minimum: 0, maximum: 20, default: 20 }),
	),
});
...
export type ReceiveMessagesResponse = Static<
	typeof ReceiveMessagesResponseSchema
>;
