...
export function ObjectUploadDialog({
	bucketName,
	prefix,
	open,
	onOpenChange,
}: ObjectUploadDialogProps) {
			...
			<DialogContent>
				...
				<form onSubmit={handleSubmit}>
					<div className="space-y-4 py-4">
						...
						<div>
							<label className="text-sm font-medium" htmlFor="object-key-input">
								Object key (optional)
							</label>
							<Input
								id="object-key-input"
								placeholder={
									file ? `${prefix}${file.name}` : "custom/path/filename.ext"
								}
								value={customKey}
