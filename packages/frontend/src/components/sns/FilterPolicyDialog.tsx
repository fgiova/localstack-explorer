...
import { useSubscriptionAttributes, useSetFilterPolicy } from "@/api/sns";
...
export function FilterPolicyDialog({ subscriptionArn, open, onOpenChange }: FilterPolicyDialogProps) {
  ...
  useEffect(() => {
    if (data?.subscription?.filterPolicy) {
      try {
        ...
        const parsed = typeof data.subscription.filterPolicy === "string"
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit the filter policy for this subscription. The filter policy defines which messages are delivered to the subscription endpoint.
          </DialogDescription>
        </DialogHeader>
