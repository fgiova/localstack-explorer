...
import { useListStacks, useDeleteStack, type Stack } from "@/api/cloudformation";
import {
  Table,
  TableBody,
  TableCell,
...
export function StackList() {
  ...
  const hasInProgress = filteredStacks.some((s) => s.status.includes("IN_PROGRESS"));
  const { data, isLoading, error } = useListStacks(hasInProgress ? 5000 : false);
      ...
      <Dialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete stack &quot;{deleteTarget}&quot;? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
