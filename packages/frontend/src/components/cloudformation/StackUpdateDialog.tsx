...
import { useUpdateStack, useGetTemplate, useGetStack } from "@/api/cloudformation";
...
export function StackUpdateDialog({ open, onOpenChange, stackName }: StackUpdateDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the template and parameters for stack <strong>{stackName}</strong>.
          </DialogDescription>
        </DialogHeader>
